...
class ParamDimensionBase: public MaxHeapOperators {
	public:
		/*! \remarks Returns the dimension type of the parameter. See
		<a href="ms-its:listsandfunctions.chm::/idx_R_list_of_dimension_types.html">List of Dimension
		Types</a>. */
...
/*! \sa  Class ParamDimensionBase,  <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_dimension_types.html">List of Dimension Types</a>.
\par Description:
...
//@}
		...
		*/
		...
		factors. See <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_screen_time_val_macros.html">List
		of Screen-Time-Value Macros</a> for macros to convert in and out of
		screen space.
