...
#define P_IS_REF			0x00010000	// is a reftarget param
#define P_HAS_DEFAULT		0x00020000	// has accessor function => a virtual param
#define P_HAS_CUR_DEFAULT	0x00040000	// has a snapshotted current default value
#define P_HAS_MS_DEFAULT	0x00080000	// has a MAXScript default
#define P_HAS_RANGE			0x00100000	// has a range specified
#define P_HAS_CLASS_ID		0x00200000	// a classID validator was given
#define P_HAS_SCLASS_ID		0x00400000	// an SClassID validator was given
#define P_UI_ENABLED		0x00800000	// indicates whether UI controls are initially enabled or diabled
#define P_HAS_PROMPT	    0x01000000	// has status line prompt string res ID for various picker buttons
#define P_HAS_CAPTION	    0x02000000	// has caption string res ID for open/save file dlgs
#define P_HAS_FILETYPES	    0x04000000	// has file types string res ID for open/save file dlgs (in MAXScript type: form)
#define P_HAS_REFNO		    0x08000000	// has refno supplied
...
class IParamBlock2 : public ReferenceTarget 
{
	public:
		...
		*/
		...
		/*! \remarks Retrieves the value of the specified parameter at the
		specified time.
		\param id The permanent ID of the parameter.
		\param t The time at which to get the value.
		\param tabIndex If the parameter is a Tab\<\> this is the zero based index into the
		...
		/*! \remarks Returns the string value of the specified parameter at
		the specified time.
		\param id The permanent ID of the parameter.
		\param t The time at which to get the value.
		\param tabIndex If the parameter is a Tab\<\> this is the zero based index into the
