...
<a href="ms-its:listsandfunctions.chm::/idx_R_list_of_standard_color_ids.html">List of Standard Color IDs</a>,
...
public:
    ...
    */
    ...
    \par Parameters:
    <b>int which</b>\n\n
    Specifies the windows color definition. See
    <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_standard_color_ids.html">List of Standard Color
    IDs</a>. For a full list of windows color definitions, please refer to the
    ...
    \par Parameters:
    <b>int which</b>\n\n
    Specifies which color to retrieve. See
    <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_viewport_drawing_color_indices.html">List of
    Viewport Drawing Color Indices</a>.
