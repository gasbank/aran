...
class Control : public ReferenceTarget {
   public:
	  ...
	  \return  One of the following values:\n\n
	  See <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_out_of_range_types.html">List of Out of Range Types</a>. */
	  ...
	  system handles this method but the controller needs to process the ORT in
	  its implementation of <b>GetValue()</b> and <b>SetValue()</b>.
	  \param ort See <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_out_of_range_types.html">List of Out of Range Types</a>.
	  \param type One of the following values:\n\n
	  <b>ORT_BEFORE</b> - leading up to the pattern\n\n
	  <b>ORT_AFTER</b> - beyond the key pattern */
...
class StdControl : public Control {
   public:     
	  ...
	  \param type See <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_out_of_range_types.html">List of Out of Range Types</a>.
	  \par Sample Code:
