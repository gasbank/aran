...
/*! \sa  Class IMenuContext, Class Interface, <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_rightclick_contexts.html">List of Right-Click Contexts</a>.\n\n
\par Description:
This class is available in release 4.0 and later only.\n\n
...
public:
    ...
    \return  See the <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_rightclick_contexts.html">List of
    Right-Click Contexts</a>.. */
    ...
    See the <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_rightclick_contexts.html">List of
    Right-Click Contexts</a>.. */
