...
\par Parameters:
<b>int i</b>\n\n
The index of the channel. See
<a href="ms-its:listsandfunctions.chm::/idx_R_list_of_gbuffer_channels_indexes.html">List of G-Buffer Channel
Indexes</a>. */
...
/*! \sa Class GBufReader, Class GBufWriter, Class GBuffer, Structure RealPixel, Structure Color24, Class Point2, <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_image_channels.html">List of Image Channels</a>,
<a href="ms-its:listsandfunctions.chm::/idx_R_list_of_g_buffer_channel_types.html">List of G-Buffer Channel Types</a>.
...
/*! \sa  Class GBuffer, Class GBufWriter, Structure GBufData, <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_gbuffer_channels_indexes.html">List of GBuffer Channels
Indexes</a>.\n\n
\par Description:
...
class GBufReader  : public InterfaceServer {
	...
	\par Parameters:
	The channel to read. One of the items from:
	<a href="ms-its:listsandfunctions.chm::/idx_R_list_of_gbuffer_channels_indexes.html">List of GBuffer
	Channels Indexes</a>.\n\n
	<b>void *data</b>\n\n
...
/*! \sa  Class GBuffer, Class GBufReader, Structure GBufData, <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_gbuffer_channels_indexes.html">List of GBuffer Channels
Indexes</a>.\n\n
\par Description:
This class is available in release 3.0 and later only.\n\n
...
class GBufWriter : public InterfaceServer {
	...
	\par Parameters:
	<b>int chan</b>\n\n
	See <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_gbuffer_channels_indexes.html">List of GBuffer
	Channels Indexes</a>.\n\n
	<b>void *data</b>\n\n
...
/*! \sa  Class GBufReader, Class GBufWriter, <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_image_channels.html">List of Image Channels</a>,
<a href="ms-its:listsandfunctions.chm::/idx_R_list_of_g_buffer_channel_types.html">List of GBuffer Channel Types</a>, 
Class Bitmap.\n\n
...
class GBuffer : public InterfaceServer {
	...
	/*! \remarks Returns the channels that are currently present. See
	<a href="ms-its:listsandfunctions.chm::/idx_R_list_of_image_channels.html">List of Image Channels</a>. */
	...
	\par Parameters:
	<b>ULONG channelID</b>\n\n
	The channel to get. See <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_image_channels.html">List of
	Image Channels</a>.\n\n
	<b>ULONG\& chanType</b>\n\n
	The channel type. See
	<a href="ms-its:listsandfunctions.chm::/idx_R_list_of_g_buffer_channel_types.html">List of G-Buffer
	Channel Types</a>. */
	...
	*/
	...
	The zero based index of the scan line.\n\n
	<b>int ichan</b>\n\n
	The channel to check. See
	<a href="ms-its:listsandfunctions.chm::/idx_R_list_of_gbuffer_channels_indexes.html">List of G-Buffer
	Channel Indexes</a>. When <b>ichan=-1</b>, it gives an array of the x
	...
	The zero based index of the scan line.\n\n
	<b>int ichan</b>\n\n
	The channel to set. See
	<a href="ms-its:listsandfunctions.chm::/idx_R_list_of_gbuffer_channels_indexes.html">List of G-Buffer
	Channel Indexes</a>. When <b>ichan=-1</b>, it sets an array of the x values
