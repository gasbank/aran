...
class TexHandleMaker: public MaxHeapOperators{
	 public: 
			...
			<b>int symflags=0</b>\n\n
			See <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_texture_symmetry_flags.html">List of Texture
			Symmetry Flags</a>.\n\n
...
struct ISect: public MaxHeapOperators {
	 ...
	 /*! The material requirements of the intersected face. See
	 <A href="ms-its:listsandfunctions.chm::/idx_R_list_of_material_requirement_flags.html">List of Material Requirement Flags</A>.  */
	 ULONG matreq;
...
#define MTL_CLONED            (1<<28)  // flag indicates material or texture was created by being cloned from another material or texture. 
...
public:
	...
	method are listed in \ref Material_TextureMap_IDs "List of Material Texture Map Indices".
	\par Parameters:
	<b>int i</b>\n\n
	...
	\return  See <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_map_slot_types.html">List of Map Slot
	Types</a>.
	\par Default Implementation:
...
class MtlBase: public ReferenceTarget, public ISubMap {
	 ...
	 public:
		...
		CoreExport ~MtlBase();
			...
			See <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_material_flags.html">List of Material Flags</a>.
			...
			otherwise zero. See <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_material_flags.html">List of
			Material Flags</a>.
			...
			\return  See <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_material_requirement_flags.html">List
			of Material Requirements</a>.
			\par Default Implementation:
			...
			*/
			...
			\param isave An interface pointer available for saving data. See Class ISave.
			\return  See <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_ioresults.html">List of
			IOResults</a>.
			\par Sample Code:
			...
			\param iload An interface pointer for calling methods to load data. See Class ILoad.
			\return  See <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_ioresults.html">List of
			IOResults</a>.
			\par Sample Code:
			\code
...
class Texmap: public MtlBase {
	 public:
			...
			\return  See <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_texture_symmetry_flags.html">List of
			Texture Symmetry Flags</a>.
			\par Default Implementation:
			...
			\par Parameters:
			<b>int sType</b>\n\n
			See <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_map_slot_types.html">List of Map Slot
			Types</a>.
			\par Default Implementation:
			<b>{}</b> */
