...
// 
/*! \sa  Class DropType, Class VIZableClipFmt, Class DropScriptClipFmt, <a href="ms-its:listsandfunctions.chm::/idx_R__list_of_droptypes.html">List of DropTypes</a>\n\n
\par Description:
This class is available in release 4.0 and later only.\n\n
...
/*! \sa  Class DropClipFormat, Class FileDropType, Class DropScriptDropType , <a href="ms-its:listsandfunctions.chm::/idx_R__list_of_droptypes.html">List of DropTypes</a>\n\n
\par Description:
This class is available in release 4.0 and later only.\n\n
...
classes. The built-in <b>DropTypes</b> are listed in the
<a href="ms-its:listsandfunctions.chm::/idx_R__list_of_droptypes.html">List of DropTypes</a>
\par Data Members:
protected:\n\n
<b>static IDragAndDropMgr* dndMgr;</b>\n\n
...
public:
   ...
   which are listed in the <a href="ms-its:listsandfunctions.chm::/idx_R__list_of_droptypes.html">List of
   DropTypes</a>
   \par Parameters:
   <b>int code</b>\n\n
   The DropType code.
...
/*! \sa  Class DropType, Class URLTab, Class SceneFileDropType, Class ImageFileDropType, Class ImportFileDropType, Class ScriptFileDropType, <a href="ms-its:listsandfunctions.chm::/idx_R__list_of_droptypes.html">List of DropTypes</a>\n\n
\par Description:
This class is available in release 4.0 and later only.\n\n
...
public:
   ...
   corresponding to the given filename suffix. See the
   <a href="ms-its:listsandfunctions.chm::/idx_R__list_of_droptypes.html">List of DropTypes</a> for more
   details.
   \par Parameters:
   <b>MCHAR* filename</b>\n\n
   The filename suffix.\n\n
...
//   intermediate base class for drop content in the form of a 
//   dropScript 
/*! \sa  Class DropType, Class DragAndDropHandler, Class FPParams, Class MacroEntry, <a href="ms-its:listsandfunctions.chm::/idx_R__list_of_droptypes.html">List of DropTypes</a>\n\n
\par Description:
This class is available in release 4.0 and later only.\n\n
...
// .max scene file
/*! \sa  Class FileDropType, <a href="ms-its:listsandfunctions.chm::/idx_R__list_of_droptypes.html">List of DropTypes</a>\n\n
\par Description:
This class is available in release 4.0 and later only.\n\n
