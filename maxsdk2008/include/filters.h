...
<b>FLT_TIMECHANGED</b> message. See
<a href="ms-its:listsandfunctions.chm::/idx_R_list_of_imagefilter_related_messages.html">List of ImageFilter
Related Messages</a>.
\par Data Members:
<b>BOOL set;</b>\n\n
...
/*! \sa  Class ImageFilter, Class ClassDesc, <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_iftr_cap_flags.html">List of Image Filter Capability
Flags</a>.\n\n
\par Description:
...
/*! \sa  Class FilterHandler,  Template Class Tab, <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_iftr_cap_flags.html">List of Image Filter Capability
Flags</a>.\n\n
\par Description:
...
class ImageFilter: public MaxHeapOperators {
   ...
   public:
	  ...
	  NULL.
	  \return  See <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_iftr_cap_flags.html">List of Image
	  Filter Capability Flags</a>. */
	...
	\endcode
	  ...
	  <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_imagefilter_related_messages.html">List of
	  ImageFilter Related Messages</a>. */
