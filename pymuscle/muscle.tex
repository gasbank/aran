...
\begin{equation}
\Delta Y(Y^{(l)}, u) = \mathbf{C}(Y^{(l)}) + \mathbf{D}(Y^{(l)})u
\end{equation}
where
\begin{equation}
\mathbf{C}(Y^{(l)}) = \mathbf{P}^{-1}(Y^{(l)}) \left( \dot{Y}_R^{(l)} + \dot{Y}_Q^{U(l)} \right),
\end{equation}
...
u^*= {} & \arg\min_{u} \| Y^{(l+1)}                            - Y_\text{desired} \|^2_{\mathbf{W}_Y} + \| u \|^2_{\mathbf{W}_u} \notag\\
   ...
   = {} & \arg\min_{u} \| (Y^{(l)} + \mathbf{C} + \mathbf{D}u) - Y_\text{desired} \|^2_{\mathbf{W}_Y} + \| u \|^2_{\mathbf{W}_u}\notag\\
   = {} & \arg\min_{u} \| \mathbf{D}u + E \|^2_{\mathbf{W}_Y}  + \| u \|^2_{\mathbf{W}_u}
\end{align}
where
\begin{equation}
E = Y^{(l)} + \mathbf{C} - Y_\text{desired}.
\end{equation}
...
2\mathbf{W}_Y(\mathbf{D}u^*+E) + 2\mathbf{W}_u u^* = {} & 0\notag\\
(\mathbf{W}_Y\mathbf{D}+\mathbf{W}_u)u^* = {} & -\mathbf{W}_Y E\notag\\
(\mathbf{W}_Y\mathbf{D}+\mathbf{W}_u)^T(\mathbf{W}_Y\mathbf{D}+\mathbf{W}_u)u^* = {} & -(\mathbf{W}_Y\mathbf{D}+\mathbf{W}_u)^T\mathbf{W}_Y E
\end{align}
