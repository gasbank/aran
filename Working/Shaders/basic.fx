                         ...
                         uniform bool bAnimate )
{
	...
	vTotalLightDiffuse = float4(0.9f, 0.1f, 0.7f, 1.0f) * max(0, dot(vNormalWorldSpace, float4(0.0f, 0.5f, -0.5f, -1.6f)));

    // Transform the position from object space to homogeneous projection space
    Output.Position = mul(vAnimatedPos, g_mWorldViewProjection);
    Output.Diffuse.rgb = float4(0.5f, 0.5f, 0.5f, 0.5f) * vTotalLightDiffuse + float4(0.0f, 1.0f, 1.0f, -1.0f) * float4(0.2f, 0.2f, 0.2f, 0.2f);
