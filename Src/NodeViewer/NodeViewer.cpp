...
BEGIN_MESSAGE_MAP(CNodeViewerApp, CWinAppEx)
...
// CNodeViewerApp construction

CNodeViewerApp::CNodeViewerApp()
{
...
// The one and only CNodeViewerApp object

CNodeViewerApp theApp;


// CNodeViewerApp initialization

BOOL CNodeViewerApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_NodeViewerTYPE,
		RUNTIME_CLASS(CNodeViewerDoc),
		RUNTIME_CLASS(CChildFrame), // custom MDI child frame
		RUNTIME_CLASS(CNodeViewerView));
	if (!pDocTemplate)
		return FALSE;
...
void CNodeViewerApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CNodeViewerApp customization load/save methods

void CNodeViewerApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CNodeViewerApp::LoadCustomState()
{
}

void CNodeViewerApp::SaveCustomState()
{
}

// CNodeViewerApp message handlers




void CNodeViewerApp::OnMytoolbarButton()
{
