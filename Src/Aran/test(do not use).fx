...
// Global variables
//--------------------------------------------------------------------------------------
float4 g_vMaterialAmbient = float4( 1.0f, 1.0f, 1.0f, 1.0f );       // Material's ambient color
float4 g_vMaterialDiffuse = float4( 1.0f, 1.0f, 1.0f, 1.0f );       // Material's diffuse color

float4   g_vLightColor = float4( 1.0f, 1.0f, 1.0f, 1.0f );        // Light color
float3   g_vLightPosition = float3( 0.0f, 0.0f, -10.0f );          // Light position
